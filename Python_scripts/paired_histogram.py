...
sys.path.insert(1,os.path.join(file_dirname,'Python_scripts','python_modules'))
from essential_genes_names import list_known_essentials #import essential_genes_names from python modules directory

#%% INPUT
datafile = r"C:\Users\linigodelacruz\Documents\PhD_2018\Documentation\SATAY\data\15022021-sequencing-data-WT-dnrp1-SATAY-from-Oxford\a-b-pooled\WT_pergene.txt"
